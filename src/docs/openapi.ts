export const openApiDocument = {
  ...
  components: {
    ...
    schemas: {
      ...
      CreateProgressRequest: { type: 'object', required: ['mode', 'score', 'maxScore', 'mistakes', 'durationMs'], properties: { mode: { type: 'string', enum: ['PHISHING', 'DOWNLOADS'] }, score: { type: 'integer', minimum: 0, maximum: 5 }, maxScore: { type: 'integer', const: 5 }, mistakes: { type: 'integer', minimum: 0, maximum: 5 }, durationMs: { type: 'integer', minimum: 1, maximum: 86400000 } } },
