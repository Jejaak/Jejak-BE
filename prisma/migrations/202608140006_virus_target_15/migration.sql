...
SET "status" = 'LOST', "completedAt" = CURRENT_TIMESTAMP, "updatedAt" = CURRENT_TIMESTAMP
WHERE "status" = 'ACTIVE';
...
ALTER TABLE "GameProgress" ADD CONSTRAINT "GameProgress_values_check" CHECK (
  ...
  (
    ...
    ("mode" = 'DOWNLOADS' AND (("maxScore" = 4 AND "score" BETWEEN 0 AND 4 AND "mistakes" BETWEEN 0 AND 3) OR ("maxScore" = 15 AND "score" BETWEEN 0 AND 15 AND "mistakes" BETWEEN 0 AND 3)))
  )
);
